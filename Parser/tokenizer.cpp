...
#define is_potential_identifier_start(c) ((isalpha(c) || (c == '_') || (c >= 128))

#define is_potential_identifier_char(c) (isdigit(c) || (is_potential_identifier_start(c)))
...
#ifndef PGEN
void TokenState::setFilename(PyObject* p_filename)
{
...
static char *
decode_str(const char *str, bool exec_input, struct tok_state *tok)
{
...
static const char *
decode_str(const char *input, bool single, struct tok_state *tok)
{
    PyObject* utf8 = NULL;
    const char *str;
    const char *s;
...
struct tok_state *
PyTokenizer_FromString(const char *str, bool exec_input)
{
